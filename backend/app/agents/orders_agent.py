...
ORDERS_SYSTEM_PROMPT = (
    ...
    "show the customer a summary as a markdown bullet list (one line per detail) and "
    "ask them to confirm it. Only call create_order after the customer has explicitly "
    "confirmed the summary in their own words (for example 'yes', 'confirm', or "
